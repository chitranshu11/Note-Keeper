...
public class DataManager {
    ...
    public CategoryInfo getCategory (String id) {
        for (CategoryInfo category  : mCategories ) {
    ...
    public List<NoteInfo> getNotes(CategoryInfo category ) {
    ...
    public int getNoteCount(CategoryInfo category) {
        int count = 0;
        for(NoteInfo note:mNotes) {
            if(category.equals(note.getCategory()))
                count++;
    ...
    private void initializeCourses() {
        mCategories.add(initializeCategory1());
        mCategories.add(initializeCategory2());
        mCategories.add(initializeCategory3());
        mCategories.add(initializeCategory4());
    }

    public void initializeExampleNotes() {
        final DataManager dm = getInstance();

        CategoryInfo course = dm.getCategory("android_intents");
        ...
        course = dm.getCategory("android_async");
        ...
        course = dm.getCategory("java_lang");
        ...
        course = dm.getCategory("java_core");
    ...
    private CategoryInfo initializeCategory1() {
        ...
        return new CategoryInfo("android_intents", "Android Programming with Intents", modules);
    }

    private CategoryInfo initializeCategory2() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new CategoryInfo("android_async", "Android Async Programming and Services", modules);
    }

    private CategoryInfo initializeCategory3() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new CategoryInfo("java_lang", "Java Fundamentals: The Java Language", modules);
    }

    private CategoryInfo initializeCategory4() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new CategoryInfo("java_core", "Java Fundamentals: The Core Platform", modules);
    }
    //endregion
